...
export type PuzzleGrid_PuzzleFragment = { __typename?: 'Puzzle', size: number, words: Array<{ __typename?: 'PlacedWord', startX: number, startY: number, isHorizontal: boolean, word: { __typename?: 'Word', word: string } }> } & { ' $fragmentName'?: 'PuzzleGrid_PuzzleFragment' };
